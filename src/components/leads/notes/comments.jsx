...
interface CommentsProps {
  ...
  onDeleteComment?: (commentId: string, noteId: string) => Promise<void>
}

export function Comments({ noteId, comments, currentUser, onAddComment, onDeleteComment }: CommentsProps) {
